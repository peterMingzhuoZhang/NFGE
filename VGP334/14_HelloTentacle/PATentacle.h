#ifndef HELLOTENTACLE_PTTENTACLE_H
#define HELLOTENTACLE_PTTENTACLE_H
...
// ---||||||||||||||---------------------------------------------------------------------------------------------------
// ---vvvvvvvvvvvvvv---------------------------------------------------------------------------------------------------
namespace PA	//Peter Amy style
{
	struct TentacleSegment
	{
		Bone mBone;
		Matrix4 boneMatrix;
		Matrix4 boneTranslateMatrix;		//New Added
...
class PATentacle	//Peter-Amy Tentacle: [Amy helps me create this one]
{
public:
...
private:
	...
	PA::TransformBuffer mTransformBuffer;
	PA::MaterialBuffer mMaterialBuffer;
	PA::BoneTransformBuffer mBoneTransferBuffer;
	PA::OptionBuffer mOptionBuffer;
	...
	//-------------------------------------------------------------------------------------------
	int mTotalSeg = 3;
	std::vector<PA::TentacleSegment> mSegs;
	//-------------------------------------------------------------------------------------------
	//- Control ---------------------------------------------------------------------------------
