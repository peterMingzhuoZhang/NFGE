...
void PTBoneMesh::Load(const NFGE::Math::Vector4& ambientColor, const NFGE::Math::Vector4& diffuseColor, DirectionalLight* light)
{
	mAmbientColor = ambientColor;
	mDiffuseColor = diffuseColor;
	mConeGeometry.Load(light);
	mSphereGeometry.Load(light);
}

void PTBoneMesh::Render(const NFGE::Math::Matrix4& toParentMat, NFGE::Math::Matrix4 & toWorldMat,const NFGE::Graphics::Camera & camera, bool isSelected)
{
