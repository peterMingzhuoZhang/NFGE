#ifndef NFGE_HELLOYBOT_MOVEMENTCONTROLLER_ALLDIRECTION_H
#define NFGE_HELLOYBOT_MOVEMENTCONTROLLER_ALLDIRECTION_H
...
#endif // !NFGE_HELLOYBOT_MOVEMENTCONTROLLER_ALLDIRECTION_H
