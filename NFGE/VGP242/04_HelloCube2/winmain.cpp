...
const wchar_t* shaderFileName = L"../../Assets/Shaders/DoTransform.fx";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
	...
	MeshPC cube = MeshBuilder::CreateCubePC();
	MeshPC plane = MeshBuilder::CreatePlanePC(5, 5, 1.0f);
	...
	vertexShader.Initialize(shaderFileName, VertexPC::Format);
