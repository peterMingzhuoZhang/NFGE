...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
	...
	Texture myTexure;
	myTexure.Initialize(L"../../Assets/Images/sponge_bob.png");
	...
	while (!done)
	{
		...
		NFGE::Graphics::SpriteRenderer::Get()->BeginRender();
		NFGE::Graphics::SpriteRenderer::Get()->Draw(myTexure, NFGE::Math::Vector2{ 100.0f, 100.0f });
		NFGE::Graphics::SpriteRenderer::Get()->EndRender();
	...
	NFGE::Graphics::SpriteRenderer::StaticTerminate();
