#ifndef HELLO3DGROUPBEHAVIOR_SPHERE_HEADER
#define HELLO3DGROUPBEHAVIOR_SPHERE_HEADER
...
struct PTSphere
{
	...
	void Terminate();
	void Update();
	void Render(const NFGE::Math::Vector3& pos, const NFGE::Math::Vector3 & rot, const NFGE::Math::Vector3 & scale, const NFGE::Graphics::Camera& cmaera);
